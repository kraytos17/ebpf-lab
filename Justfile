...
bench-release:
    cargo bench -p ebpf-isa --locked --bench decode -- --measurement-time 3 --warm-up-time 1 --sample-size 200
    cargo bench -p ebpf-cfg --locked --bench cfg -- --measurement-time 3 --warm-up-time 1 --sample-size 200
    cargo bench -p ebpf-vm --locked --bench vm -- --measurement-time 3 --warm-up-time 1 --sample-size 200
    cargo bench -p ebpf-verifier --locked --bench verify -- --measurement-time 3 --warm-up-time 1 --sample-size 200
